...
nc = 1
pretrained = './CRNN/expr2/netCRNN_100_5.pth' # path to pretrained model (to continue training)
# pretrained = ''
expr_dir = './CRNN/expr2' # where to store samples and models
...
n_val_disp = 200 # number of samples to display when val the model

# finetune
nepoch = 1000 # number of epochs to train for
batchSize = 128 # input batch size
lr = 1e-5 # learning rate for Critic, not used by adadealta 0.0001
